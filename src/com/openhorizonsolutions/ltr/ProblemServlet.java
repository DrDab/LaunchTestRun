...
public class ProblemServlet extends HttpServlet
{
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
	{
		...
		catch (Exception e)
		{
			...
			DataStore.forensicsLogger.logError(exceptionAsString, request.getRemoteAddr());
			s = "";
			s += header;
			s += 
					"\n" + 
					...
					"<div class=\"card\" style=\"Background-color: #ea4335; width:800px; padding-top:10px; padding-bottom:10px;\"><div class=\"container\"><center><plain style=\"color:#ffffff; font-size=0.8em;\">Oops, something went wrong. *blushes* X///3<br>Stack trace:<br>" + exceptionAsString + "</plain></center></div></div>" +
					"</span>\n" + 
					"</div>\n" +
					"</div>\n" + 
					"\n" + 
