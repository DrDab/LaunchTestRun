<%@ page import="java.io.*, com.openhorizonsolutions.ltr.*"
		...
		<div class="shadow1">
			<div class="content">
				...
				<div class="card"
					...
					<div class="container">
						<center>
							<plain style="color:#ffffff; font-size=0.8em;"> <subsection>Error
							403: Access Denied</subsection> </plain>
						</center>
					</div>
				</div>
				<br>
				<div align="left" class="card"
					...
					<div class="container">
						<span id="probtext-text" class="mathjax"> <plain>
							The page that you have requested has been denied, due to
							inadequate permissions. <br>
							<br>
							To return to the homepage, please click <a
								href="<%=response.encodeURL(request.getContextPath() + "/index.html")%>">here</a>.
							<br>
							To view a list of problems, please click <a
								href="<%=response.encodeURL(request.getContextPath() + "/listproblems.html")%>">here</a>.
							</plain> <br>
						</span>
					</div>
					<br>
